...
knitr::include_graphics("images/BIDE-Figure.png")
```
...
$$\begin{align}
  & \text{Birth (fish per year;}\,B)=4 \\ 
 & \text{Immigration (fish per year;}\,I)=0 \\ 
 & \text{Death (fish per year;}\,D)=3 \\ 
 & \text{Emigration (fish per year;}\,E)=0 \\ 
\end{align}$$
...
8. Using the data in Table 1 plot the change in abundance over time ( ; 
